...
const APP_LOCAL_STORAGE_KEYS = [
  ...
  "specfiles_tree_width",
  "specfiles_ideas_width",
  "specfiles_flows_width",
  "specfiles_chat_active",
  "specfiles_active_idea_id",
  "specfiles_active_flow_id",
  "testpage_active_tab",
  "runner_selected_test_id",
