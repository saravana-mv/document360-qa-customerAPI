        ...
        >
          ...
          >
            <div className="flex items-center gap-2 px-4 py-3 border-b border-[#d1d9e0]">
              ...
              <span className="text-base font-semibold text-[#1f2328]">Remove from implementation list?</span>
            </div>
            <div className="px-4 py-3">
              <p className="text-sm text-[#656d76] leading-relaxed">
                ...
                the implementation queue. The flow can be re-marked from Spec Manager.
              </p>
            </div>
