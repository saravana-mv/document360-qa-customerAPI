              ...
              <div className="px-4 py-8 text-center space-y-3">
                ...
                <div className="flex flex-col gap-2">
                  <button
                    ...
                    disabled={syncing}
                    className="inline-flex items-center justify-center gap-1.5 text-sm font-medium text-white bg-[#1f883d] hover:bg-[#1a7f37] rounded-md px-3 py-1.5 transition-colors disabled:opacity-50"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          {hasSelection ? (
            <>
              ...
              <div className="flex items-center gap-1.5 px-4 h-10 border-b border-[#d1d9e0] bg-[#f6f8fa] shrink-0">
                <svg className="w-4 h-4 text-[#25292e] shrink-0" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <div className="text-center space-y-4 max-w-sm">
                    ...
                    <div className="flex items-center gap-2 justify-center">
                      ...
                      <button
                        onClick={() => setShowIdeasChat(true)}
                        title="Create ideas interactively via chat"
                        className="inline-flex items-center gap-1.5 border border-[#d1d9e0] text-[#1f2328] hover:bg-[#f6f8fa] text-sm font-medium rounded-md px-3 py-2 transition-colors"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
                        </svg>
            ...
            <div className="w-[360px] bg-white rounded-xl shadow-xl border border-[#d1d9e0]/70 p-5" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={(e) => { e.preventDefault(); const input = (e.target as HTMLFormElement).elements.namedItem("name") as HTMLInputElement; void handleRenameFolder(rf.id, input.value); }}>
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button type="submit" className="text-sm font-medium text-white bg-[#1f883d] hover:bg-[#1a7f37] px-3 py-1.5 rounded-md">Rename</button>
                </div>
              </form>
            </div>
          </div>
