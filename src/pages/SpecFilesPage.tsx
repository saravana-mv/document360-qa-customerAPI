...
export function SpecFilesPage() {
  ...
  function buildSkillsTemplate(folderPath: string, variables?: SuggestedVariable[]): string {
    ...
    return [
      ...
      "  steps. Never assume required entities already exist. Prerequisite endpoints",
      "  may belong to a different resource folder (e.g. the categories spec may be",
      "  in a sibling folder) — always include them in the flow even when generating",
