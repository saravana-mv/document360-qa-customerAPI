...
import { FolderRulesPanel } from "../components/specfiles/FolderRulesPanel";
import {
  listSpecFiles,
  getSpecFileContent,
  uploadSpecFile,
...
export function SpecFilesPage() {
  ...
  // ── Folder-level API Rules panel toggle ─────────────────────────────────
  const [showRulesPanel, setShowRulesPanel] = useState(false);
  // Close rules panel when folder changes
  useEffect(() => { setShowRulesPanel(false); }, [selectedFolderPath]);
