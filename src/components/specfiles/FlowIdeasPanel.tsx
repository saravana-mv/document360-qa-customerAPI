      ...
      <div className="flex items-center gap-2 px-4 h-10 border-b border-[#d1d9e0] bg-[#f6f8fa] shrink-0">
        ...
        {selectedCount > 0 && (
          <button
            ...
            className="text-sm text-[#d1242f] hover:text-[#d1242f]/80 disabled:opacity-40 flex items-center gap-0.5"
          >
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 shrink-0 mt-0.5 text-[#afb8c1] hover:text-[#d1242f] rounded-md p-0.5 hover:bg-[#ffebe9] transition-colors"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setShowDeleteConfirm(false)}>
            <div className="bg-white rounded-lg shadow-xl border border-[#d1d9e0] w-[400px] max-w-[90vw]" onClick={e => e.stopPropagation()}>
              <div className="flex items-center gap-2 px-4 py-3 border-b border-[#d1d9e0]">
                ...
                <span className="text-base font-semibold text-[#1f2328]">Delete {deletingCount} idea{deletingCount !== 1 ? "s" : ""}?</span>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setRowDeleteId(null)}>
            <div className="bg-white rounded-lg shadow-xl border border-[#d1d9e0] w-[420px] max-w-[90vw]" onClick={e => e.stopPropagation()}>
              <div className="flex items-center gap-2 px-4 py-3 border-b border-[#d1d9e0]">
                ...
                <span className="text-base font-semibold text-[#1f2328]">Delete idea?</span>
              </div>
              <div className="px-4 py-3 space-y-2">
                <p className="text-sm text-[#656d76] leading-relaxed">
