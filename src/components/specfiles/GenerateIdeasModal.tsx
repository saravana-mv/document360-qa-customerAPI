...
export function GenerateIdeasModal({ folderPath, onGenerate, onClose, currentMode, disabled }: Props) {
  ...
  // Build sorted folder list with indented display names
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
        ...
        >
          ...
          <div className="px-5 space-y-4 text-left">
            ...
            {/* Spec files */}
            <div>
              <label className="text-sm font-medium text-[#656d76] mb-1.5 block">Spec files <span className="text-[#d1242f]">*</span></label>
              <button
...
export function chipIcon(key: string, _active = false): React.ReactNode {
  const cls = "w-3 h-3";
  switch (key) {
    case "random":
    ...
    case "happy":
      return <svg className={cls} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>;
    case "crud":
    ...
    case "pagination":
      return <svg className={cls} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12M8.25 17.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>;
    case "boundaries":
