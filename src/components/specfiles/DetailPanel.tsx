      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            title="Copy prompt"
            className="flex items-center gap-1 text-sm text-[#656d76] hover:text-[#0969da] rounded-md px-1.5 py-0.5 hover:bg-[#ddf4ff] transition-colors"
          >
            {promptCopied ? (
              <>
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden p-4 space-y-2">
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <span className="text-sm font-mono text-[#656d76] flex-1 truncate">{flow.title}</span>
      ...
      {isView && validation && !validation.ok && (
        <div className="px-3 py-2 bg-[#ffebe9] border border-[#ffcecb] rounded-md text-sm text-[#d1242f] flex items-start gap-2 shrink-0">
          ...
          <div className="min-w-0">
            ...
            <div className="font-mono text-sm mt-0.5 break-all">{validation.error}</div>
          </div>
        </div>
      )}
    ...
    return (
      <div className="flex-1 flex items-center justify-center h-full">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-[#656d76]">Select an idea or flow</p>
        </div>
      </div>
    );
  }
