    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: "rgba(0,0,0,0.5)" }}>
      ...
      >
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          {/* Left: Flow XML */}
          <div className="flex-1 flex flex-col min-w-0 border-r border-[#d1d9e0]">
            <div className="flex items-center gap-2 px-4 h-9 border-b border-[#d1d9e0] bg-[#f6f8fa] shrink-0">
              ...
              <span className="text-xs font-semibold text-[#656d76] uppercase tracking-wider">Flow XML</span>
            </div>
          ...
          <div className="flex flex-col overflow-hidden" style={{ width: 420, minWidth: 320 }}>
            <div className="flex items-center gap-2 px-4 h-9 border-b border-[#d1d9e0] bg-[#f6f8fa] shrink-0">
              <svg className="w-3.5 h-3.5 text-[#656d76]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
              </svg>
              <span className="text-xs font-semibold text-[#656d76] uppercase tracking-wider">Issues</span>
