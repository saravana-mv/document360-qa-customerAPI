...
export function SideNav() {
  return (
    <nav className="w-16 bg-gray-900 flex flex-col items-center py-3 gap-1 shrink-0">
      {/* Logo mark */}
      ...
      {NAV_ITEMS.map((item) => (
        <NavLink
          ...
          className={({ isActive }) =>
            [
              "w-12 h-12 rounded-lg flex flex-col items-center justify-center gap-0.5 transition-colors text-[9px] font-medium leading-tight text-center",
              isActive
