          ...
          {flowFileName && (
            <>
              ...
              <button
                ...
                disabled={deleting}
                title="Delete flow and its tests"
                className="shrink-0 opacity-0 group-hover:opacity-100 text-[#656d76] hover:text-[#cf222e] rounded p-0.5 hover:bg-white transition-opacity disabled:opacity-50"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
