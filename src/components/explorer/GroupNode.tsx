  ...
  return (
    <div className="mb-1">
      ...
      >
        ...
        <span className="text-xs font-semibold text-[#1f2328] flex-1">{name}</span>
        <span className="text-[11px] text-[#656d76] shrink-0">
          {groupTests.length}
        </span>
        {selectedCount > 0 && (
          <span className="text-[10px] text-[#0969da] font-medium shrink-0 px-1.5 py-px rounded-full bg-[#ddf4ff] border border-[#b6e3ff]">
