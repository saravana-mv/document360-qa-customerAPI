    ...
    <ExplorerContext.Provider value={{ expandSignal, expandAll }}>
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2 px-4 py-2 border-b border-gray-200 bg-white shrink-0">
          ...
          <button onClick={handleExpandAll} className="text-xs text-gray-500 hover:underline">Expand</button>
          <span className="text-gray-300">|</span>
          <button onClick={handleCollapseAll} className="text-xs text-gray-500 hover:underline">Collapse</button>
          <span className="text-gray-300">|</span>
