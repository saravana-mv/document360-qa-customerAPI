    ...
    <ExplorerContext.Provider value={{ expandSignal, expandAll }}>
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2 px-3 py-2 border-b border-[#d1d9e0] bg-[#f6f8fa] shrink-0">
          <span className="text-xs font-semibold text-[#1f2328]">Tests</span>
          <div className="flex-1" />
          <button onClick={handleExpandAll} className="text-[11px] text-[#656d76] hover:text-[#0969da] hover:underline">Expand</button>
          <span className="text-[#d1d9e0]">·</span>
          <button onClick={handleCollapseAll} className="text-[11px] text-[#656d76] hover:text-[#0969da] hover:underline">Collapse</button>
          <span className="text-[#d1d9e0]">·</span>
          <button onClick={selectAll} className="text-[11px] text-[#0969da] hover:underline">All</button>
          <span className="text-[#d1d9e0]">·</span>
          <button onClick={clearSelection} className="text-[11px] text-[#656d76] hover:text-[#0969da] hover:underline">None</button>
        </div>
