        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 bg-[#f6f8fa] border-b border-[#d1d9e0]">
            <tr>
              ...
              <th className="text-left px-3 py-2 font-medium text-[#1f2328]">Run ID</th>
              ...
              >
                ...
                <td className="px-3 py-2">
                  <span className="inline-flex items-center gap-1">
                    <code className="text-xs text-[#656d76] font-mono">{run.id.replace("run:", "").slice(0, 8)}</code>
                    <button
                      onClick={(e) => { e.stopPropagation(); navigator.clipboard.writeText(run.id); }}
                      className="p-0.5 rounded text-[#8b949e] hover:text-[#0969da] hover:bg-[#ddf4ff] transition-colors"
