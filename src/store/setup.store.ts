...
export const useSetupStore = create<SetupState>((set, get) => ({
  ...
  delayBetweenStepsMs: typeof cached.delayBetweenStepsMs === "number" ? (cached.delayBetweenStepsMs as number) : 2000,
  delayBetweenScenariosMs: typeof cached.delayBetweenScenariosMs === "number" ? (cached.delayBetweenScenariosMs as number) : 5000,
